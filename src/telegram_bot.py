...
def telegram_bot_send_text(token, sender_chat_id, message):
    url = f'https://api.telegram.org/bot{token}/sendMessage?chat_id={sender_chat_id}&parse_mode=Markdown&text={message}'
